...
class MainWindow(BoxLayout):
    ...
    def _create_settings_tab(self):
        ...
        self.settings_result.bind(text=lambda _, __: setattr(self.settings_result,
                                  'height', max(self.settings_result.minimum_height, 100)))
    ...
    def _create_init_tab(self):
        ...
        self.init_result.bind(text=lambda _, __: setattr(
            self.init_result, 'height', max(self.init_result.minimum_height, 200)))
    ...
    def _create_analyze_tab(self):
        ...
        self.analyze_result.bind(text=lambda _, __: setattr(
            self.analyze_result, 'height', max(self.analyze_result.minimum_height, 200)))
    ...
    def _create_acquire_tab(self):
        ...
        self.acquire_req_text.bind(text=lambda _, __: setattr(self.acquire_req_text,
                                   'height', max(self.acquire_req_text.minimum_height, 150)))
        ...
        self.acquire_result.bind(text=lambda _, __: setattr(
            self.acquire_result, 'height', max(self.acquire_result.minimum_height, 200)))
    ...
    def _create_develop_tab(self):
        ...
        self.develop_req_text.bind(text=lambda _, __: setattr(self.develop_req_text,
                                   'height', max(self.develop_req_text.minimum_height, 150)))
        ...
        self.develop_result.bind(text=lambda _, __: setattr(
            self.develop_result, 'height', max(self.develop_result.minimum_height, 200)))
    ...
    def _create_test_tab(self):
        ...
        self.test_result.bind(text=lambda _, __: setattr(
            self.test_result, 'height', max(self.test_result.minimum_height, 200)))
    ...
    def _create_accept_tab(self):
        ...
        self.accept_req_text.bind(text=lambda _, __: setattr(self.accept_req_text,
                                  'height', max(self.accept_req_text.minimum_height, 150)))
        ...
        self.accept_result.bind(text=lambda _, __: setattr(
            self.accept_result, 'height', max(self.accept_result.minimum_height, 200)))
