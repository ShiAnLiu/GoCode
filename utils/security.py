...
import json
import pathlib
from typing import IO, Optional, Union, Dict, Any
...
class SecurityManager:
    ...
    支持通过 config/security_config.json 配置文件扩展名、文件大小、目录限制等安全策略。
    """
